  ...
  <div>
    ...
    <div class="table_contain">
      ...
      >
        ...
        <el-table-column prop="zsno" label="证书编号"> </el-table-column>
        <el-table-column prop="photoList" label="附照片">
        ...
        <el-table-column prop="time" label="评审年月"> </el-table-column>
        <el-table-column prop="app" label="聘任小级"> </el-table-column>
        <el-table-column prop="appTime" label="聘任年月"> </el-table-column>
        <el-table-column prop="appYear" label="聘任年数"> </el-table-column>
    ...
    >
      <div>
        <el-form :model="form" label-width="100px">
          ...
          <el-form-item label="聘任年数:">
            <el-input
              class="inp"
              :disabled="formType == 2"
              size="small"
              v-model="form.appYear"
            ></el-input>
          </el-form-item>
        </el-form>
      </div>
