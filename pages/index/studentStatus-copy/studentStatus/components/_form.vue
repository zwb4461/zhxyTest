  ...
  <div>
    ...
    >
        ...
        <a-col :span="24">
          ...
          >
            <a-textarea
              ...
              placeholder="请备注到街道（镇），格式如：骆驼街道或九龙湖镇"
            ></a-textarea>
          </a-form-model-item>
        </a-col>
      </a-row>
        ...
        <a-col :span="8">
          <a-form-model-item label="入学年月">
            <a-month-picker
              ...
              format="YYYY-MM"
              v-model="data.goTime"
              :defaultValue="moment('2020-09', 'YYYY-MM')"
            />
          </a-form-model-item>
        </a-col>
        <a-col :span="8">
      ...
      <a-row>
        ...
        <a-col :span="8">
          <a-form-model-item label="通讯地址" prop="postalAddress">
            <a-input
      ...
      <a-form-model-item class="sk_box">
...
export default {
  ...
  watch: {
    ...
    "data.hometown"(nv) {
      if (nv) {
        this.form.hometown = JSON.stringify(nv);
      } else {
        this.form.hometown = "";
      }

      // console.log("hometown", this.form.hometown);
    },
    "data.csd"(nv) {
      if (nv) {
        this.form.csd = JSON.stringify(nv);
      } else {
        this.form.csd = "";
      }

      // console.log("csd", this.form.csd);
    },
    //监听使用期限
  ...
  methods: {
    ...
    setForm(data) {
      ...
      this.form.fatheridno = data.fatheridno;
      this.form.motheridno = data.motheridno;
      this.form.otheridno = data.otheridno;

      this.data.hometown = JSON.parse(data.hometown);
      this.data.csd = JSON.parse(data.csd);
